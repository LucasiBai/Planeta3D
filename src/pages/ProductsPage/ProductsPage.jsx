  ...
  return (
    <>
      ...
      <section className="section-client">
		...
		<PageTitle subtitle={"Te ayudamos a diseñar tus ideas"} className="pregunta-cliente">
          ¿No estas seguro de qué elegir?
        </PageTitle>
        <img src="./assets/astronauta-saturno.png" className="img-astronauta" alt="astronauta" />
		</div>
      </section>
	  <section>
		<ContactPage/>
